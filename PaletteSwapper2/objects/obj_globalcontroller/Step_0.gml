...
#region DEBUG
var keyReset = input_check_pressed(ord("R"));
if (keyReset)
{
	room_restart();
}

var keySuperReset = input_check_pressed(ord("R")) && input_check(vk_control);
if (keySuperReset)
{
	audio_stop_all();
	game_restart();
...
var keyScreencap = input_check_pressed(vk_f12);
if (keyScreencap)
{
...
if (input_check_pressed(192))	// 192 = Tilde "~" key
{
	DEBUG ^= 1;
...
#region PAUSING
if (input_check_pressed(global.key_pause) ||
